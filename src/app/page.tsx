...
const ExternalLinkIcon = () => (
  <svg className="external-link" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <div className="min-h-screen theme-bg-primary">
      ...
      <Section>
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="inline-flex items-center rounded-full theme-border px-3 py-1 text-sm font-medium theme-bg-secondary theme-text-primary">
              {profile.metric}
            </div>
            
            <p className="text-xl theme-text-primary font-medium">
              {profile.motto}
            </p>
          </div>
      ...
      <Section className="border-t theme-border">
        <div className="space-y-8">
          <h2 className="text-2xl font-bold text-center theme-text-primary">Projects</h2>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {project.mrr && (
                      <span className="inline-block text-xs font-medium theme-text-tertiary">
                        {project.mrr}
                      </span>
                    )}
                  </div>
                  {project.href.startsWith('http') && <ExternalLinkIcon />}
                </div>
              </a>
            ))}
          </div>
      ...
      <Section className="border-t theme-border">
        <div className="text-center space-y-4">
          <p className="theme-text-secondary">
            I share build-in-public updates, startup ideas, and revenue insights.
          </p>
          <a
            href={`mailto:${profile.email}?subject=Subscribe`}
